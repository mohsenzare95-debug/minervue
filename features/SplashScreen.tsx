...
const styles: any = {
  ...
  upperLid: {
    ...
    height: "55%",
    background: "#111",
borderBottomLeftRadius: "70% 80%",
borderBottomRightRadius: "70% 80%",    boxShadow: "0 10px 25px rgba(0,0,0,.08)",
  ...
  lowerLid: {
    ...
    height: "55%",
    background: "#111",
borderTopLeftRadius: "70% 80%",
borderTopRightRadius: "70% 80%",    boxShadow: "0 -10px 25px rgba(0,0,0,.08)",
    transition: "transform .6s cubic-bezier(.25,.8,.25,1)",
    zIndex: 1000,
  },
};