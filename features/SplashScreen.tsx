...
const styles: any = {
  ...
  upperLid: {
    ...
    height: "65%",
    background: "#111",
borderBottomLeftRadius: "700px 180px",
borderBottomRightRadius: "700px 180px",    boxShadow: "0 10px 25px rgba(0,0,0,.08)",
  ...
  lowerLid: {
    ...
    height: "65%",
    background: "#111",
borderTopLeftRadius: "700px 180px",
borderTopRightRadius: "700px 180px",    boxShadow: "0 -10px 25px rgba(0,0,0,.08)",
    transition: "transform .6s cubic-bezier(.25,.8,.25,1)",
    zIndex: 1000,
  },
};